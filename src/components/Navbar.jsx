            ...
            <div className="container mx-auto flex justify-between items-center">
                ...
                <div className="flex items-center space-x-4">
                    <button
                        ...
                        className={`py-2.5 px-4 rounded-md text-white text-xl font-medium transition duration-300 
                    ...
                    {categories.map((category, index) => (
                        <button
                            ...
                            className={`py-2.5 px-4 rounded-md text-white text-base font-medium transition duration-300 
                ...
                <div className="flex items-center space-x-3">
                    ...
                    <ToggleMode />
                    <Link to="/cart" className="text-yellow-400 mr-2 text-lg font-semibold">
                        🛒Cart
                    </Link>
                </div>
            </div>
